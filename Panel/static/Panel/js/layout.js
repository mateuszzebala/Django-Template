...
const toggle_left_panel = document.querySelector('.toggle-left-panel')
...
toggle_left_panel.addEventListener("click", ()=>{
    if(left_panel.classList.contains('open')){
        left_panel.classList.remove('open')
    }
    else{
        left_panel.classList.add('open')
    }
})
const toggle_topbar = ()=>{
...
document.querySelectorAll('a.confirm-a').forEach(a=>{
    ...
    a.addEventListener("click", (e)=>{
        ...
        link.href = a.href
        link.innerHTML = e.target.innerHTML + a.getAttribute('confirm')
        cw.appendChild(link)
